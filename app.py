...
def banco(sql):
    ...
    try:
        ...
        conn = psycopg2.connect(
            host = "dpg-cuhv2dbqf0us73dnog20-a.oregon-postgres.render.com",
            port = "5432",
            dbname = "senaidb_rc26",
            user = "senaidb_rc26_user",
            password = "TWANPTsyIppbfAVIvybrgig8bmeO2bac"
        )

        #postgresql://senaidb_rc26_user:TWANPTsyIppbfAVIvybrgig8bmeO2bac@dpg-cuhv2dbqf0us73dnog20-a.oregon-postgres.render.com/senaidb_rc26
